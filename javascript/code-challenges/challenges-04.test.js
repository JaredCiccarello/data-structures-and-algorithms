...
const updateAnimal = (arr, callback) => {
  ...
  let newArr = [];
    ...
    // We have two callback functions here.
  arr.forEach(animal => newArr.push(callback(animal)))

  return newArr

  // Reminder, name things exaclty what they are, it will be easier for you to go over what you did.
};

...
// steps: find math.pow()).
// We need to intialize an array
// Using math.pow we need to find our base:
// We find our base by...creating a variable that helps us identify our numbers
//math.pow automatically ^3
...
// This is used to just test if an array works. In this case we won't need to use this.
// let arr = [1, 2, 3];

// We want this to take in an array of numbers
// Next return an new array of each of those numbers raised to the 3rd power
